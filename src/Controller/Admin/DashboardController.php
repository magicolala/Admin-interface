...
class DashboardController extends AbstractDashboardController
{
    ...
    public function configureMenuItems(): iterable
    {
        ...
        yield MenuItem::subMenu('Actions', 'fas fa-bar')->setSubItems([
            ...
            MenuItem::linkToCrud('Show Products', 'fas fa-eye', Product::class)->setAction(Crud::PAGE_INDEX),
        ...
        yield MenuItem::subMenu('Categories', 'fas fa-bar')->setSubItems([
            ...
            MenuItem::linkToCrud('Show Categories', 'fas fa-eye', Category::class)->setAction(Crud::PAGE_INDEX),
        ]);
    }
}
